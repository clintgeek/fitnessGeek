...
class FoodApiService {
  ...
  transformUSDAFood(food) {
    ...
    return {
      ...
      nutrition: {
        calories_per_serving: Math.round(nutrients['energy'] || nutrients['calories'] || 0),
        protein_grams: Math.round((nutrients['protein'] || 0) * 10) / 10,
        carbs_grams: Math.round((nutrients['carbohydrate, by difference'] || nutrients['carbohydrates'] || 0) * 10) / 10,
        fat_grams: Math.round((nutrients['total lipid (fat)'] || nutrients['fat'] || 0) * 10) / 10,
        fiber_grams: Math.round((nutrients['fiber, total dietary'] || nutrients['fiber'] || 0) * 10) / 10,
        sugar_grams: Math.round((nutrients['sugars, total including nlea'] || nutrients['sugar'] || 0) * 10) / 10,
        sodium_mg: Math.round((nutrients['sodium, na'] || nutrients['sodium'] || 0) * 10) / 10
      },
      serving: {
        size: 100,
        unit: 'g'
  ...
  transformOpenFoodFactsProduct(product) {
    ...
    return {
      ...
      nutrition: {
        calories_per_serving: Math.round(nutriments['energy-kcal_100g'] || nutriments['energy_100g'] / 4.184 || 0),
        protein_grams: Math.round((nutriments.proteins_100g || 0) * 10) / 10,
        carbs_grams: Math.round((nutriments.carbohydrates_100g || 0) * 10) / 10,
        fat_grams: Math.round((nutriments.fat_100g || 0) * 10) / 10,
        fiber_grams: Math.round((nutriments.fiber_100g || 0) * 10) / 10,
        sugar_grams: Math.round((nutriments.sugars_100g || 0) * 10) / 10,
        sodium_mg: Math.round((nutriments.sodium_100g || 0) * 10) / 10
      },
      serving: {
        size: 100,
        unit: 'g'
